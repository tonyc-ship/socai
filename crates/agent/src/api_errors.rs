...
const EMPTY_BODY_HINT: &str = "empty response body — usually means a malformed/empty API key or auth header. Check ~/.socai/auth.json or run `socai-dev auth --provider X` to re-enter.";
